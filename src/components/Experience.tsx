...
function Experience() {
   return (
      <section dir="ltr" id="experience" className="bg-quaternary py-spacing-12">
         <SectionHeading>السيرة الشخصية</SectionHeading>
            ...
            {experiencesData.map((item, index) => (
               <React.Fragment key={index}>
                  <VerticalTimelineElement
                     ...
                     {/* Description */}
                     <p className="text-2xl w-fit">{item.description}</p>
                  </VerticalTimelineElement>
               </React.Fragment>
            ))}
         </VerticalTimeline>
